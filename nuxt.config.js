...
module.exports = {
  ...
  head: {
    ...
    link: [
      ...
      },
      {
        rel: "stylesheet",
        href:
          "https://cdn.byu.edu/byu-theme-components/latest/byu-theme-components.min.css"
      },
      {
        rel: "stylesheet",
        href:
      ...
      },
      {
        rel: "stylesheet",
        href:
          "https://cdn.byu.edu/byu-calendar-components/latest/byu-calendar.min.css"
      },
      {
    ...
    script: [
      {
        async: "true",
        src:
          "https://cdn.byu.edu/byu-theme-components/latest/byu-theme-components.min.js"
      },
      {
        async: "true",
   ...
   ** Global CSS
   */
  css: ["@/assets/fonts.css", "@/assets/honors-styles.css"],
  ...
  generate: {
    routes: function() {
      return axios.get("http://127.0.0.1:3000/api/stories").then(res => {
