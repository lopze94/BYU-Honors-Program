  ...
  return new Vuex.Store({
    ...
    actions: {
      ...
      addSpotlight(context, spotlight) {
        ...
        axios
          .post("/api/spotlight", formData, headers)
          .then(response => {
      ...
      async deleteSpotlight(context, student) {
        ...
        try {
          const response = await axios.delete(
            "/api/spotlight/" + student.id + "/" + student.image_path,
            headers
          );
      ...
      addStory(context, stories) {
        ...
        formData.append("category", stories.category);
        ...
        axios
          .post("/api/stories", formData, headers)
          .then(response => {
      ...
      async deleteStory(context, story) {
        ...
        try {
          const response = await axios.delete(
            "/api/stories/" + story.id + "/" + story.image_path,
            headers
          );
